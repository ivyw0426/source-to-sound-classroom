      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-700">
            ...
            community, build ArcGIS maps, create a StoryMap, draft a policy
            recommendation, publish the URL, and present at a symposium.
          </p>
          {!compact ? (
            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
              The structure is 5 lessons, 1 per week, 45-60 minutes per lesson,
              hosted on Zoom.
            </p>
          ) : null}
        ...
        <div className="grid gap-4 rounded-[28px] bg-white p-5 shadow-soft ring-1 ring-water-100">
          <div className="rounded-[24px] bg-water-900 p-6 text-white">
            ...
            <h2 className="mt-10 text-2xl font-bold">
              Research, map, publish, and present an ArcGIS StoryMap.
            </h2>
          </div>
